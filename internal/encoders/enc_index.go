...
type encoderFactory = func(size image.Point, frameRate int) (EncoderInterface, error)
...
func NewEncoderService() ServiceInterface {
	return &EncoderService{}
}

//NewEncoder creates an instance of an encoder of the selected codec
func (*EncoderService) NewEncoder(codec VideoCodec, size image.Point, frameRate int) (EncoderInterface, error) {
