...
type RemoteScreenService struct {
	stunServer      string
	videoService    rdisplay.ServiceInterface
	encodingService encoders.ServiceInterface
}

// NewRemoteScreenService creates a new instances of RemoteScreenService
func NewRemoteScreenService(stun string, video rdisplay.ServiceInterface, enc encoders.ServiceInterface) Service {
